...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            m_probability = parent_probability(mother)
            f_probability = parent_probability(father)
            if num_genes == 2:
                gene_probability = m_probability * f_probability
            elif num_genes == 1:
                gene_probability = m_probability * (1 - f_probability) + f_probability * (1 - m_probability)
            else:
                gene_probability = (1 - m_probability) * (1 - f_probability)
